...
namespace _8bitVonNeiman.ExternalDevices.LCDDisplay.View
{
    public partial class LCDDisplayForm : Form, LCDDisplaySettingsForm.Output, LCDDisplayMemoryForm.Output
    {
        ...
        {
            LCDDisplaySettingsForm settingsForm = new LCDDisplaySettingsForm(this, lcdBackgroundColor, lcdEnabledColor);
            settingsForm.ShowDialog(this);
        }

        public void Save(Color backgroundColor, Color symbolColor)
        {
