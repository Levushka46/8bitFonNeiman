...
namespace _8bitVonNeiman.ExternalDevices.SerialController.LCDDisplay.View
{
    public partial class LCDDisplaySettingsForm : Form
    {
        ...
        {
            void Save(Color backgroundColor, Color symbolColor, bool enmem);
        }
        ...
        public LCDDisplaySettingsForm(Output output, Color backgroundColor, Color symbolColor, bool enmem)
        {
            InitializeComponent();
            this.output = output;
            this.backgroundColor = backgroundColor;
            this.symbolColor = symbolColor;
            enMemory.Checked = enmem;
            ShowBackgroundColor();
            ShowSymbolColor();
        }
        ...
        {
            output.Save(backgroundColor, symbolColor,enMemory.Checked);
        }
